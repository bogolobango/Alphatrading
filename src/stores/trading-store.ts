...
export const useTradingStore = create<TradingState>()(
  persist(
    (set) => ({
      ...
      trades: mockTrades,
      watchlist: [
        { id: "aapl", symbol: "AAPL", name: "Apple Inc.", addedAt: Date.now() },
        { id: "nvda", symbol: "NVDA", name: "NVIDIA Corp.", addedAt: Date.now() },
        { id: "spy", symbol: "SPY", name: "SPDR S&P 500 ETF", addedAt: Date.now() },
      ],
      alerts: [],
      selectedPair: "AAPL",
